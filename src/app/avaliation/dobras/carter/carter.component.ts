...
@Component({
  selector: 'app-carter',
  templateUrl: './carter.component.html',
  styleUrls: ['./carter.component.scss']
})
export class CarterComponent implements OnInit {
  evaluation: any = [];
  ...
  startGraphics(evaluation) {
    ...
    const proto = this.protocolos.protocoloCarter6d(evaluation, this.gorduraDesejada);
    // Create graphic
    this.showChart = true;
