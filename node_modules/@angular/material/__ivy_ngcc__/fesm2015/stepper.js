...
function MatHorizontalStepper_ng_container_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function MatHorizontalStepper_ng_container_1_Template_mat_step_header_click_1_listener($event) { const step_r11 = ctx.$implicit; return step_r11.select(); })("keydown", function MatHorizontalStepper_ng_container_1_Template_mat_step_header_keydown_1_listener($event) { ɵngcc0.ɵɵrestoreView(_r17); const ctx_r16 = ɵngcc0.ɵɵnextContext(); return ctx_r16._onKeydown($event); });
    ɵngcc0.ɵɵelementEnd();
    ...
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("tabIndex", ctx_r9._getFocusIndex() === i_r12 ? 0 : 0 - 1)("id", ctx_r9._getStepLabelId(i_r12))("index", i_r12)("state", ctx_r9._getIndicatorType(i_r12, step_r11.state))("label", step_r11.stepLabel || step_r11.label)("selected", ctx_r9.selectedIndex === i_r12)("active", step_r11.completed || ctx_r9.selectedIndex === i_r12 || !ctx_r9.linear)("optional", step_r11.optional)("errorMessage", step_r11.errorMessage)("iconOverrides", ctx_r9._iconOverrides)("disableRipple", ctx_r9.disableRipple);
    ɵngcc0.ɵɵattribute("aria-posinset", i_r12 + 1)("aria-setsize", ctx_r9.steps.length)("aria-controls", ctx_r9._getStepContentId(i_r12))("aria-selected", ctx_r9.selectedIndex == i_r12)("aria-label", step_r11.ariaLabel || null)("aria-labelledby", !step_r11.ariaLabel && step_r11.ariaLabelledby ? step_r11.ariaLabelledby : null);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", !isLast_r13);
} }
function MatHorizontalStepper_div_3_Template(rf, ctx) { if (rf & 1) {
    const _r21 = ɵngcc0.ɵɵgetCurrentView();
    ɵngcc0.ɵɵelementStart(0, "div", 7);
    ɵngcc0.ɵɵlistener("@stepTransition.done", function MatHorizontalStepper_div_3_Template_div_animation_stepTransition_done_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r21); const ctx_r20 = ɵngcc0.ɵɵnextContext(); return ctx_r20._animationDone.next($event); });
    ...
    ɵngcc0.ɵɵproperty("@stepTransition", ctx_r10._getAnimationDirection(i_r19))("id", ctx_r10._getStepContentId(i_r19));
    ɵngcc0.ɵɵattribute("tabindex", ctx_r10.selectedIndex === i_r19 ? 0 : null)("aria-labelledby", ctx_r10._getStepLabelId(i_r19))("aria-expanded", ctx_r10.selectedIndex === i_r19);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngTemplateOutlet", step_r18.content);
} }
function MatVerticalStepper_div_0_Template(rf, ctx) { if (rf & 1) {
    const _r28 = ɵngcc0.ɵɵgetCurrentView();
    ɵngcc0.ɵɵelementStart(0, "div", 1);
    ɵngcc0.ɵɵelementStart(1, "mat-step-header", 2);
    ɵngcc0.ɵɵlistener("click", function MatVerticalStepper_div_0_Template_mat_step_header_click_1_listener($event) { const step_r23 = ctx.$implicit; return step_r23.select(); })("keydown", function MatVerticalStepper_div_0_Template_mat_step_header_keydown_1_listener($event) { ɵngcc0.ɵɵrestoreView(_r28); const ctx_r27 = ɵngcc0.ɵɵnextContext(); return ctx_r27._onKeydown($event); });
    ɵngcc0.ɵɵelementEnd();
    ɵngcc0.ɵɵelementStart(2, "div", 3);
    ɵngcc0.ɵɵelementStart(3, "div", 4);
    ɵngcc0.ɵɵlistener("@stepTransition.done", function MatVerticalStepper_div_0_Template_div_animation_stepTransition_done_3_listener($event) { ɵngcc0.ɵɵrestoreView(_r28); const ctx_r29 = ɵngcc0.ɵɵnextContext(); return ctx_r29._animationDone.next($event); });
    ...
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("tabIndex", ctx_r22._getFocusIndex() == i_r24 ? 0 : 0 - 1)("id", ctx_r22._getStepLabelId(i_r24))("index", i_r24)("state", ctx_r22._getIndicatorType(i_r24, step_r23.state))("label", step_r23.stepLabel || step_r23.label)("selected", ctx_r22.selectedIndex === i_r24)("active", step_r23.completed || ctx_r22.selectedIndex === i_r24 || !ctx_r22.linear)("optional", step_r23.optional)("errorMessage", step_r23.errorMessage)("iconOverrides", ctx_r22._iconOverrides)("disableRipple", ctx_r22.disableRipple);
    ɵngcc0.ɵɵattribute("aria-posinset", i_r24 + 1)("aria-setsize", ctx_r22.steps.length)("aria-controls", ctx_r22._getStepContentId(i_r24))("aria-selected", ctx_r22.selectedIndex === i_r24)("aria-label", step_r23.ariaLabel || null)("aria-labelledby", !step_r23.ariaLabel && step_r23.ariaLabelledby ? step_r23.ariaLabelledby : null);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵclassProp("mat-stepper-vertical-line", !isLast_r25);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("@stepTransition", ctx_r22._getAnimationDirection(i_r24))("id", ctx_r22._getStepContentId(i_r24));
    ɵngcc0.ɵɵattribute("tabindex", ctx_r22.selectedIndex === i_r24 ? 0 : null)("aria-labelledby", ctx_r22._getStepLabelId(i_r24))("aria-expanded", ctx_r22.selectedIndex === i_r24);
    ɵngcc0.ɵɵadvance(2);
